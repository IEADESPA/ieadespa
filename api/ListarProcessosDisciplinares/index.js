...
// Núcleo mínimo (v0.2). Exige a permissão "disciplina" — quem não tem essa permissão
// não vê processos disciplinares em lugar nenhum (diferente do mascaramento parcial
// usado em GestaoPessoas, aqui é a tela inteira).
...
const SITUACOES_ATIVAS = ["EM_ANDAMENTO", "EXCLUIDO", "PRAZO_INDETERMINADO", "CUMPRINDO_SANCAO"];
